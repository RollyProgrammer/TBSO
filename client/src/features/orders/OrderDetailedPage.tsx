...
import { Box, Button, Card, Divider, Table, TableBody, TableCell, TableContainer, TableRow } from "@mui/material";
...
export default function OrderDetailedPage() {
  ...
  return (
    <Card sx={{ p: 2, maxWidth: "md", mx: "auto" }}>
      ...
      <Box mx={3} gap={2} display="flex" flexDirection="column" mt={2}>
      ...
      <Box component="dl" sx={{ display: "flex", justifyContent: "space-between" }} mx={3} mt={2}>
        <Typography component="dt" variant="subtitle1" fontWeight="500">
          Total
        </Typography>
